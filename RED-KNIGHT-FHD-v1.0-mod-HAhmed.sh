...
if [ -d /usr/share/enigma2/RED-KNIGHT-FHD ]; then
echo "> removing package please wait..."
sleep 3s 
rm -rf /usr/share/enigma2/RED-KNIGHT-FHD >/dev/null 2>&1
...
#config
skin=RED-KNIGHT-FHD-v1.0-mod-HAhmed
version=1.0
url=https://raw.githubusercontent.com/Ham-ahmed/knight/refs/heads/main/RED-KNIGHT-FHD.tar.gz
